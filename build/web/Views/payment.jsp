...
<div class="container">
    ...
    <div class="ticket-box">
        ...
        <table class="ticket-table">
            ...
            <tr>
                <th>Phim:</th>
                <td>${bookingInfo.movie_title}</td>
            </tr>
            <tr>
                <th>Phòng chiếu:</th>
                <td>${bookingInfo.auditorium_name}</td>
            </tr>
            <tr>
                <th>Ghế:</th>
                <td>${bookingInfo.seat_code} (${bookingInfo.seat_type})</td>
            </tr>
            <tr>
                <th>Suất chiếu:</th>
                <td>
                    <fmt:formatDate value="${bookingInfo.start_time}" pattern="HH:mm dd/MM/yyyy" />
                </td>
            </tr>
        </table>
    </div>
    ...
    <!-- ✅ Hiển thị tổng tiền -->
    <div class="total-box">
        <p><b>Tổng gốc:</b> <fmt:formatNumber value="${bookingInfo.total_price}" type="number" /> VND</p>
        <p><b>Sau giảm:</b>
            <fmt:formatNumber value="${discountedTotal != null ? discountedTotal : bookingInfo.total_price}" type="number" /> VND
        </p>
    </div>
    ...
    <form action="${pageContext.request.contextPath}/checkout" method="post" class="pay-form">
        ...
        <input type="hidden" name="amount"
               value="${discountedTotal != null ? discountedTotal : bookingInfo.total_price}" />
