            ...
            <div class="seat-layout">
                ...
                <div class="form-container">
                    ...
                    <form method="post" action="seatDelete">
                        ...
                        <button class="btn-hide" type="submit" name="action" value="hide">Ẩn ghế</button>
                        <button class="btn-show" type="submit" name="action" value="show">Khôi phục ghế</button>
                    </form>
                </div>
            </div>
